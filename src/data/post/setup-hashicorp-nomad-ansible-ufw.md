...
Nun sind wir mit den Tasks durch, wir legen nun noch in `defaults/main.yml` einen Wert für ufw_apps_allow für OpenSSH an, damit wir uns immer über SSH verbinden können. Sonst vergessen wir ggf. die Variable und dann sperren wir uns selber aus.
