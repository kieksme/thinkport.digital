...
* Speicherung: Auch in diesem Bereich gab es Änderungen. Zum Beispiel wurde das field “allow\_blob\_public\_access” in “allow\_nested\_items\_to\_be\_public” umbenannt. In der Vergangenheit führte die bisherige (etwas ungenaue) Bezeichnung oft zu Verwirrungen. “allow\_nested\_items\_to\_be\_public” gibt an, was die Bezeichnung verspricht: Elemente innerhalb eines Speicherkontos der Öffentlichkeit können zugänglich gemacht werden. Und eben nicht, dass alle Ressourcen innerhalb dieses Speicherkontos standardmäßig öffentlich werden.
